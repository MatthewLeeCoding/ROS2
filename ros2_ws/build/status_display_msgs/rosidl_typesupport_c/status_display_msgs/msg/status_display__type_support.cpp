...
static const _StatusDisplay_type_support_symbol_names_t _StatusDisplay_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, status_display_msgs, msg, StatusDisplay)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, status_display_msgs, msg, StatusDisplay)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, status_display_msgs, msg, StatusDisplay)() {
  return &::status_display_msgs::msg::rosidl_typesupport_c::StatusDisplay_message_type_support_handle;
}
