...
inline void to_flow_style_yaml(
  const GenerateTwists_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const GenerateTwists_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use dwb_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const dwb_msgs::srv::GenerateTwists_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  dwb_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use dwb_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const dwb_msgs::srv::GenerateTwists_Event & msg)
{
  return dwb_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<dwb_msgs::srv::GenerateTwists_Event>()
{
  return "dwb_msgs::srv::GenerateTwists_Event";
}

template<>
inline const char * name<dwb_msgs::srv::GenerateTwists_Event>()
{
  return "dwb_msgs/srv/GenerateTwists_Event";
}

template<>
struct has_fixed_size<dwb_msgs::srv::GenerateTwists_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<dwb_msgs::srv::GenerateTwists_Event>
  : std::integral_constant<bool, has_bounded_size<dwb_msgs::srv::GenerateTwists_Request>::value && has_bounded_size<dwb_msgs::srv::GenerateTwists_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<dwb_msgs::srv::GenerateTwists_Event>
  : std::true_type {};
