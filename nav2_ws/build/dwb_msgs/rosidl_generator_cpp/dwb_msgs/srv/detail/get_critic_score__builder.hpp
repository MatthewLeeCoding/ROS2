...
class Init_GetCriticScore_Event_response
{
public:
  explicit Init_GetCriticScore_Event_response(::dwb_msgs::srv::GetCriticScore_Event & msg)
  : msg_(msg)
  {}
  ::dwb_msgs::srv::GetCriticScore_Event response(::dwb_msgs::srv::GetCriticScore_Event::_response_type arg)
  {
...
private:
  ::dwb_msgs::srv::GetCriticScore_Event msg_;
};

class Init_GetCriticScore_Event_request
{
public:
  explicit Init_GetCriticScore_Event_request(::dwb_msgs::srv::GetCriticScore_Event & msg)
  : msg_(msg)
  {}
  Init_GetCriticScore_Event_response request(::dwb_msgs::srv::GetCriticScore_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_GetCriticScore_Event_response(msg_);
  }
...
class Init_GetCriticScore_Event_info
{
public:
  Init_GetCriticScore_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_GetCriticScore_Event_request info(::dwb_msgs::srv::GetCriticScore_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_GetCriticScore_Event_request(msg_);
  }
...
template<>
inline
auto build<::dwb_msgs::srv::GetCriticScore_Event>()
{
  return dwb_msgs::srv::builder::Init_GetCriticScore_Event_info();
}
