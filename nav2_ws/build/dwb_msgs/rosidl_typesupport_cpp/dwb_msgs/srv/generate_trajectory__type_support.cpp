...
static const _GenerateTrajectory_Event_type_support_symbol_names_t _GenerateTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dwb_msgs, srv, GenerateTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dwb_msgs, srv, GenerateTrajectory_Event)),
  }
};
...
{
  return &::dwb_msgs::srv::rosidl_typesupport_cpp::GenerateTrajectory_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dwb_msgs, srv, GenerateTrajectory_Event)() {
  return get_message_type_support_handle<dwb_msgs::srv::GenerateTrajectory_Event>();
}
...
static const rosidl_service_type_support_t GenerateTrajectory_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dwb_msgs::srv::GenerateTrajectory_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dwb_msgs::srv::GenerateTrajectory_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<dwb_msgs::srv::GenerateTrajectory_Event>(),
