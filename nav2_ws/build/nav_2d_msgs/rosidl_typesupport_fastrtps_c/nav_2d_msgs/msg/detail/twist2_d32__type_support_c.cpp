...
#include "nav_2d_msgs/msg/detail/twist2_d32__rosidl_typesupport_fastrtps_c.h"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_2d_msgs__msg__Twist2D32;
    is_plain =
      (
...
static size_t _Twist2D32__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav_2d_msgs__msg__Twist2D32(
