...
#include "nav2_msgs/msg/detail/particle__rosidl_typesupport_fastrtps_c.h"
...
using _Particle__ros_msg_type = nav2_msgs__msg__Particle;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Particle__ros_msg_type * ros_message = static_cast<const _Particle__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Particle__ros_msg_type * ros_message = static_cast<_Particle__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs__msg__Particle;
    is_plain =
      (
...
static size_t _Particle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav2_msgs__msg__Particle(
