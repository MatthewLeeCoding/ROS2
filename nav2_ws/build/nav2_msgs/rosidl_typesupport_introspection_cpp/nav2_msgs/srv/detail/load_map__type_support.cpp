...
{
  new (message_memory) nav2_msgs::srv::LoadMap_Request(_init);
}

void LoadMap_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nav2_msgs::srv::LoadMap_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadMap_Request_message_member_array[1] = {
  {
    ...
    offsetof(nav2_msgs::srv::LoadMap_Request, map_url),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadMap_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(nav2_msgs::srv::LoadMap_Request),
...
{
  return &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_msgs, srv, LoadMap_Request)() {
  return &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_Request_message_type_support_handle;
}
...
void LoadMap_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) nav2_msgs::srv::LoadMap_Response(_init);
}

void LoadMap_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nav2_msgs::srv::LoadMap_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadMap_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::srv::LoadMap_Response, map),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::srv::LoadMap_Response, result),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadMap_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(nav2_msgs::srv::LoadMap_Response),
...
{
  return &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_msgs, srv, LoadMap_Response)() {
  return &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_Response_message_type_support_handle;
}
...
void LoadMap_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) nav2_msgs::srv::LoadMap_Event(_init);
}

void LoadMap_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nav2_msgs::srv::LoadMap_Event *>(message_memory);
  typed_message->~LoadMap_Event();
}

size_t size_function__LoadMap_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<nav2_msgs::srv::LoadMap_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<nav2_msgs::srv::LoadMap_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<nav2_msgs::srv::LoadMap_Request> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const nav2_msgs::srv::LoadMap_Request *>(
    get_const_function__LoadMap_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<nav2_msgs::srv::LoadMap_Request *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<nav2_msgs::srv::LoadMap_Request *>(
    get_function__LoadMap_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const nav2_msgs::srv::LoadMap_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<nav2_msgs::srv::LoadMap_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<nav2_msgs::srv::LoadMap_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<nav2_msgs::srv::LoadMap_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__LoadMap_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const nav2_msgs::srv::LoadMap_Response *>(
    get_const_function__LoadMap_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<nav2_msgs::srv::LoadMap_Response *>(untyped_value);
  value = item;
}
...
void assign_function__LoadMap_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<nav2_msgs::srv::LoadMap_Response *>(
    get_function__LoadMap_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const nav2_msgs::srv::LoadMap_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LoadMap_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::srv::LoadMap_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_msgs::srv::LoadMap_Request>(),  // members of sub message
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(nav2_msgs::srv::LoadMap_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_msgs::srv::LoadMap_Response>(),  // members of sub message
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(nav2_msgs::srv::LoadMap_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LoadMap_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(nav2_msgs::srv::LoadMap_Event),
...
{
  return &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_msgs, srv, LoadMap_Event)() {
  return &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_Event_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers LoadMap_service_members = {
  ...
  // see get_service_type_support_handle<nav2_msgs::srv::LoadMap>()
...
static const rosidl_service_type_support_t LoadMap_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_msgs::srv::LoadMap_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_msgs::srv::LoadMap_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<nav2_msgs::srv::LoadMap_Event>(),
...
get_service_type_support_handle<nav2_msgs::srv::LoadMap>()
{
  ...
  auto service_type_support =
    &::nav2_msgs::srv::rosidl_typesupport_introspection_cpp::LoadMap_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_msgs, srv, LoadMap)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<nav2_msgs::srv::LoadMap>();
}
