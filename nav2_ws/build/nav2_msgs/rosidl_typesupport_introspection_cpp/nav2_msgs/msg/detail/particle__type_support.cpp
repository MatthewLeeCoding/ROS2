...
{
  new (message_memory) nav2_msgs::msg::Particle(_init);
}

void Particle_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nav2_msgs::msg::Particle *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Particle_message_member_array[2] = {
  {
    ...
    offsetof(nav2_msgs::msg::Particle, pose),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs::msg::Particle, weight),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::nav2_msgs::msg::rosidl_typesupport_introspection_cpp::Particle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav2_msgs, msg, Particle)() {
  return &::nav2_msgs::msg::rosidl_typesupport_introspection_cpp::Particle_message_type_support_handle;
}
