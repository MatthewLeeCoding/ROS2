...
nav2_msgs__srv__ClearCostmapExceptRegion_Request__create()
{
  ...
  nav2_msgs__srv__ClearCostmapExceptRegion_Request * msg = (nav2_msgs__srv__ClearCostmapExceptRegion_Request *)allocator.allocate(sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence__init(nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__srv__ClearCostmapExceptRegion_Request *)allocator.zero_allocate(size, sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence * array = (nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence *)allocator.allocate(sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__srv__ClearCostmapExceptRegion_Request * data =
      (nav2_msgs__srv__ClearCostmapExceptRegion_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__srv__ClearCostmapExceptRegion_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__srv__ClearCostmapExceptRegion_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__srv__ClearCostmapExceptRegion_Response * msg = (nav2_msgs__srv__ClearCostmapExceptRegion_Response *)allocator.allocate(sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence__init(nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (nav2_msgs__srv__ClearCostmapExceptRegion_Response *)allocator.zero_allocate(size, sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence * array = (nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence *)allocator.allocate(sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    nav2_msgs__srv__ClearCostmapExceptRegion_Response * data =
      (nav2_msgs__srv__ClearCostmapExceptRegion_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__srv__ClearCostmapExceptRegion_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__srv__ClearCostmapExceptRegion_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
nav2_msgs__srv__ClearCostmapExceptRegion_Event__init(nav2_msgs__srv__ClearCostmapExceptRegion_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(msg);
    return false;
  }
  // request
  if (!nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence__init(&msg->request, 0)) {
    nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(msg);
    return false;
  }
  // response
  if (!nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence__init(&msg->response, 0)) {
    nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(msg);
    return false;
  }
  return true;
...
void
nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(nav2_msgs__srv__ClearCostmapExceptRegion_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence__fini(&msg->request);
  // response
  nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence__fini(&msg->response);
}

bool
nav2_msgs__srv__ClearCostmapExceptRegion_Event__are_equal(const nav2_msgs__srv__ClearCostmapExceptRegion_Event * lhs, const nav2_msgs__srv__ClearCostmapExceptRegion_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
...
bool
nav2_msgs__srv__ClearCostmapExceptRegion_Event__copy(
  const nav2_msgs__srv__ClearCostmapExceptRegion_Event * input,
  nav2_msgs__srv__ClearCostmapExceptRegion_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!nav2_msgs__srv__ClearCostmapExceptRegion_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!nav2_msgs__srv__ClearCostmapExceptRegion_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
nav2_msgs__srv__ClearCostmapExceptRegion_Event__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__srv__ClearCostmapExceptRegion_Event * msg = (nav2_msgs__srv__ClearCostmapExceptRegion_Event *)allocator.allocate(sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Event));
  bool success = nav2_msgs__srv__ClearCostmapExceptRegion_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
nav2_msgs__srv__ClearCostmapExceptRegion_Event__destroy(nav2_msgs__srv__ClearCostmapExceptRegion_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(msg);
...
bool
nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__init(nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__srv__ClearCostmapExceptRegion_Event * data = NULL;

  if (size) {
    data = (nav2_msgs__srv__ClearCostmapExceptRegion_Event *)allocator.zero_allocate(size, sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = nav2_msgs__srv__ClearCostmapExceptRegion_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__fini(nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * array = (nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence *)allocator.allocate(sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__destroy(nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__are_equal(const nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * lhs, const nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!nav2_msgs__srv__ClearCostmapExceptRegion_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence__copy(
  const nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * input,
  nav2_msgs__srv__ClearCostmapExceptRegion_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(nav2_msgs__srv__ClearCostmapExceptRegion_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    nav2_msgs__srv__ClearCostmapExceptRegion_Event * data =
      (nav2_msgs__srv__ClearCostmapExceptRegion_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!nav2_msgs__srv__ClearCostmapExceptRegion_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          nav2_msgs__srv__ClearCostmapExceptRegion_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!nav2_msgs__srv__ClearCostmapExceptRegion_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
