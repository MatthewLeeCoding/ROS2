...
enum
{
  nav2_msgs__srv__LoadMap_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__srv__LoadMap_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/LoadMap in the package nav2_msgs.
typedef struct nav2_msgs__srv__LoadMap_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__srv__LoadMap_Request__Sequence request;
  nav2_msgs__srv__LoadMap_Response__Sequence response;
} nav2_msgs__srv__LoadMap_Event;

// Struct for a sequence of nav2_msgs__srv__LoadMap_Event.
typedef struct nav2_msgs__srv__LoadMap_Event__Sequence
{
