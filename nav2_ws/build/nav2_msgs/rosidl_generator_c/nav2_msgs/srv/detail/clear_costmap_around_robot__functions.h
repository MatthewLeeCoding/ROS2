...
#ifndef NAV2_MSGS__SRV__DETAIL__CLEAR_COSTMAP_AROUND_ROBOT__FUNCTIONS_H_
#define NAV2_MSGS__SRV__DETAIL__CLEAR_COSTMAP_AROUND_ROBOT__FUNCTIONS_H_
...
/// Check for srv/ClearCostmapAroundRobot message equality.
/**
...
/// Copy a srv/ClearCostmapAroundRobot message.
/**
...
/// Check for srv/ClearCostmapAroundRobot message array equality.
/**
...
/// Copy an array of srv/ClearCostmapAroundRobot messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nav2_msgs__srv__ClearCostmapAroundRobot_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__ClearCostmapAroundRobot_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It allocates the memory for the array and calls
 * nav2_msgs__srv__ClearCostmapAroundRobot_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__ClearCostmapAroundRobot_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAV2_MSGS__SRV__DETAIL__CLEAR_COSTMAP_AROUND_ROBOT__FUNCTIONS_H_
