...
#ifndef NAV2_MSGS__SRV__DETAIL__IS_PATH_VALID__FUNCTIONS_H_
#define NAV2_MSGS__SRV__DETAIL__IS_PATH_VALID__FUNCTIONS_H_
...
/// Initialize srv/IsPathValid message.
/**
...
/// Finalize srv/IsPathValid message.
/**
...
/// Create srv/IsPathValid message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nav2_msgs__srv__IsPathValid_Request__init().
...
/// Destroy srv/IsPathValid message.
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Request__fini()
...
/// Check for srv/IsPathValid message equality.
/**
...
/// Copy a srv/IsPathValid message.
/**
...
/// Initialize array of srv/IsPathValid messages.
/**
...
/// Finalize array of srv/IsPathValid messages.
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Request__fini()
...
/// Create array of srv/IsPathValid messages.
/**
...
/// Destroy array of srv/IsPathValid messages.
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/IsPathValid message array equality.
/**
...
/// Copy an array of srv/IsPathValid messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nav2_msgs__srv__IsPathValid_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * nav2_msgs__srv__IsPathValid_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * nav2_msgs__srv__IsPathValid_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It allocates the memory for the array and calls
 * nav2_msgs__srv__IsPathValid_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_nav2_msgs
...
/**
 * It calls
 * nav2_msgs__srv__IsPathValid_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // NAV2_MSGS__SRV__DETAIL__IS_PATH_VALID__FUNCTIONS_H_
