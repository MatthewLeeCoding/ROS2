...
enum
{
  nav2_msgs__action__AssistedTeleop_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__AssistedTeleop_Goal__UNKNOWN = 730
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__AssistedTeleop_Goal__TIMEOUT = 731
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__AssistedTeleop_Goal__TF_ERROR = 732
};
...
enum
{
  nav2_msgs__action__AssistedTeleop_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__action__AssistedTeleop_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/AssistedTeleop in the package nav2_msgs.
typedef struct nav2_msgs__action__AssistedTeleop_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__action__AssistedTeleop_SendGoal_Request__Sequence request;
  nav2_msgs__action__AssistedTeleop_SendGoal_Response__Sequence response;
} nav2_msgs__action__AssistedTeleop_SendGoal_Event;

// Struct for a sequence of nav2_msgs__action__AssistedTeleop_SendGoal_Event.
typedef struct nav2_msgs__action__AssistedTeleop_SendGoal_Event__Sequence
{
...
enum
{
  nav2_msgs__action__AssistedTeleop_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__action__AssistedTeleop_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/AssistedTeleop in the package nav2_msgs.
typedef struct nav2_msgs__action__AssistedTeleop_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__action__AssistedTeleop_GetResult_Request__Sequence request;
  nav2_msgs__action__AssistedTeleop_GetResult_Response__Sequence response;
} nav2_msgs__action__AssistedTeleop_GetResult_Event;

// Struct for a sequence of nav2_msgs__action__AssistedTeleop_GetResult_Event.
typedef struct nav2_msgs__action__AssistedTeleop_GetResult_Event__Sequence
{
