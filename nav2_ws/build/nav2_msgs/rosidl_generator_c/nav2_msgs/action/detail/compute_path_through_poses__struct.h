...
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__UNKNOWN = 300
};

/// Constant 'INVALID_PLANNER'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__INVALID_PLANNER = 301
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__TF_ERROR = 302
};

/// Constant 'START_OUTSIDE_MAP'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__START_OUTSIDE_MAP = 303
};

/// Constant 'GOAL_OUTSIDE_MAP'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__GOAL_OUTSIDE_MAP = 304
};

/// Constant 'START_OCCUPIED'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__START_OCCUPIED = 305
};

/// Constant 'GOAL_OCCUPIED'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__GOAL_OCCUPIED = 306
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__TIMEOUT = 307
};

/// Constant 'NO_VALID_PATH'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__NO_VALID_PATH = 308
};

/// Constant 'NO_VIAPOINTS_GIVEN'.
enum
{
  nav2_msgs__action__ComputePathThroughPoses_Goal__NO_VIAPOINTS_GIVEN = 309
};
