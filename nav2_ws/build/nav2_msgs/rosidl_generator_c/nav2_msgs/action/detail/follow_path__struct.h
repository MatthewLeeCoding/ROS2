...
enum
{
  nav2_msgs__action__FollowPath_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__FollowPath_Goal__UNKNOWN = 100
};

/// Constant 'INVALID_CONTROLLER'.
enum
{
  nav2_msgs__action__FollowPath_Goal__INVALID_CONTROLLER = 101
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__FollowPath_Goal__TF_ERROR = 102
};

/// Constant 'INVALID_PATH'.
enum
{
  nav2_msgs__action__FollowPath_Goal__INVALID_PATH = 103
};

/// Constant 'PATIENCE_EXCEEDED'.
enum
{
  nav2_msgs__action__FollowPath_Goal__PATIENCE_EXCEEDED = 104
};

/// Constant 'FAILED_TO_MAKE_PROGRESS'.
enum
{
  nav2_msgs__action__FollowPath_Goal__FAILED_TO_MAKE_PROGRESS = 105
};

/// Constant 'NO_VALID_CONTROL'.
enum
{
  nav2_msgs__action__FollowPath_Goal__NO_VALID_CONTROL = 106
};
