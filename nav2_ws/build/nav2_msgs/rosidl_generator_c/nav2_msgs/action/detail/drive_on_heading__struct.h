...
enum
{
  nav2_msgs__action__DriveOnHeading_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__DriveOnHeading_Goal__UNKNOWN = 720
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__DriveOnHeading_Goal__TIMEOUT = 721
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__DriveOnHeading_Goal__TF_ERROR = 722
};

/// Constant 'COLLISION_AHEAD'.
enum
{
  nav2_msgs__action__DriveOnHeading_Goal__COLLISION_AHEAD = 723
};

/// Constant 'INVALID_INPUT'.
enum
{
  nav2_msgs__action__DriveOnHeading_Goal__INVALID_INPUT = 724
};
