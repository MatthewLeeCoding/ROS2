...
enum
{
  nav2_msgs__action__SmoothPath_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__SmoothPath_Goal__UNKNOWN = 500
};

/// Constant 'INVALID_SMOOTHER'.
enum
{
  nav2_msgs__action__SmoothPath_Goal__INVALID_SMOOTHER = 501
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__SmoothPath_Goal__TIMEOUT = 502
};

/// Constant 'SMOOTHED_PATH_IN_COLLISION'.
enum
{
  nav2_msgs__action__SmoothPath_Goal__SMOOTHED_PATH_IN_COLLISION = 503
};

/// Constant 'FAILED_TO_SMOOTH_PATH'.
enum
{
  nav2_msgs__action__SmoothPath_Goal__FAILED_TO_SMOOTH_PATH = 504
};

/// Constant 'INVALID_PATH'.
enum
{
  nav2_msgs__action__SmoothPath_Goal__INVALID_PATH = 505
};
