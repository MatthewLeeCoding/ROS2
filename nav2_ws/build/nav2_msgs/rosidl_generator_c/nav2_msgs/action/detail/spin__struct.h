...
enum
{
  nav2_msgs__action__Spin_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__Spin_Goal__UNKNOWN = 700
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__Spin_Goal__TIMEOUT = 701
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__Spin_Goal__TF_ERROR = 702
};

/// Constant 'COLLISION_AHEAD'.
enum
{
  nav2_msgs__action__Spin_Goal__COLLISION_AHEAD = 703
};
