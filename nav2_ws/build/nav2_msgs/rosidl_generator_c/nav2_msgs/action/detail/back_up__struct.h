...
enum
{
  nav2_msgs__action__BackUp_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__BackUp_Goal__UNKNOWN = 710
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__BackUp_Goal__TIMEOUT = 711
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__BackUp_Goal__TF_ERROR = 712
};

/// Constant 'INVALID_INPUT'.
enum
{
  nav2_msgs__action__BackUp_Goal__INVALID_INPUT = 713
};

/// Constant 'COLLISION_AHEAD'.
enum
{
  nav2_msgs__action__BackUp_Goal__COLLISION_AHEAD = 714
};
