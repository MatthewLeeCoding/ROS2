...
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__UNKNOWN = 200
};

/// Constant 'INVALID_PLANNER'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__INVALID_PLANNER = 201
};

/// Constant 'TF_ERROR'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__TF_ERROR = 202
};

/// Constant 'START_OUTSIDE_MAP'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__START_OUTSIDE_MAP = 203
};

/// Constant 'GOAL_OUTSIDE_MAP'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__GOAL_OUTSIDE_MAP = 204
};

/// Constant 'START_OCCUPIED'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__START_OCCUPIED = 205
};

/// Constant 'GOAL_OCCUPIED'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__GOAL_OCCUPIED = 206
};

/// Constant 'TIMEOUT'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__TIMEOUT = 207
};

/// Constant 'NO_VALID_PATH'.
enum
{
  nav2_msgs__action__ComputePathToPose_Goal__NO_VALID_PATH = 208
};
...
enum
{
  nav2_msgs__action__ComputePathToPose_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__action__ComputePathToPose_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ComputePathToPose in the package nav2_msgs.
typedef struct nav2_msgs__action__ComputePathToPose_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__action__ComputePathToPose_SendGoal_Request__Sequence request;
  nav2_msgs__action__ComputePathToPose_SendGoal_Response__Sequence response;
} nav2_msgs__action__ComputePathToPose_SendGoal_Event;

// Struct for a sequence of nav2_msgs__action__ComputePathToPose_SendGoal_Event.
typedef struct nav2_msgs__action__ComputePathToPose_SendGoal_Event__Sequence
{
...
enum
{
  nav2_msgs__action__ComputePathToPose_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  nav2_msgs__action__ComputePathToPose_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ComputePathToPose in the package nav2_msgs.
typedef struct nav2_msgs__action__ComputePathToPose_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  nav2_msgs__action__ComputePathToPose_GetResult_Request__Sequence request;
  nav2_msgs__action__ComputePathToPose_GetResult_Response__Sequence response;
} nav2_msgs__action__ComputePathToPose_GetResult_Event;

// Struct for a sequence of nav2_msgs__action__ComputePathToPose_GetResult_Event.
typedef struct nav2_msgs__action__ComputePathToPose_GetResult_Event__Sequence
{
