...
enum
{
  nav2_msgs__action__FollowWaypoints_Goal__NONE = 0
};

/// Constant 'UNKNOWN'.
enum
{
  nav2_msgs__action__FollowWaypoints_Goal__UNKNOWN = 600
};

/// Constant 'TASK_EXECUTOR_FAILED'.
enum
{
  nav2_msgs__action__FollowWaypoints_Goal__TASK_EXECUTOR_FAILED = 601
};
