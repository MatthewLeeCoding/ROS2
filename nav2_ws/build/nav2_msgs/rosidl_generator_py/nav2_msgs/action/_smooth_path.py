...
class Metaclass_SmoothPath_Goal(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'INVALID_SMOOTHER': cls.__constants['INVALID_SMOOTHER'],
            'TIMEOUT': cls.__constants['TIMEOUT'],
            'SMOOTHED_PATH_IN_COLLISION': cls.__constants['SMOOTHED_PATH_IN_COLLISION'],
            'FAILED_TO_SMOOTH_PATH': cls.__constants['FAILED_TO_SMOOTH_PATH'],
    ...
    def NONE(self):
        ...
        return Metaclass_SmoothPath_Goal.__constants['NONE']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_SmoothPath_Goal.__constants['UNKNOWN']

    @property
    def INVALID_SMOOTHER(self):
        """Message constant 'INVALID_SMOOTHER'."""
        return Metaclass_SmoothPath_Goal.__constants['INVALID_SMOOTHER']

    @property
    def TIMEOUT(self):
        """Message constant 'TIMEOUT'."""
        return Metaclass_SmoothPath_Goal.__constants['TIMEOUT']

    @property
    def SMOOTHED_PATH_IN_COLLISION(self):
        """Message constant 'SMOOTHED_PATH_IN_COLLISION'."""
        return Metaclass_SmoothPath_Goal.__constants['SMOOTHED_PATH_IN_COLLISION']

    @property
    def FAILED_TO_SMOOTH_PATH(self):
        """Message constant 'FAILED_TO_SMOOTH_PATH'."""
        return Metaclass_SmoothPath_Goal.__constants['FAILED_TO_SMOOTH_PATH']

    @property
    def INVALID_PATH(self):
        """Message constant 'INVALID_PATH'."""
        return Metaclass_SmoothPath_Goal.__constants['INVALID_PATH']
...
class Metaclass_SmoothPath_SendGoal_Event(type):
...
class SmoothPath_SendGoal_Event(metaclass=Metaclass_SmoothPath_SendGoal_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SmoothPath_SendGoal_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SmoothPath_SendGoal_Response'"
...
class SmoothPath_SendGoal(metaclass=Metaclass_SmoothPath_SendGoal):
    ...
    from nav2_msgs.action._smooth_path import SmoothPath_SendGoal_Event as Event
...
class Metaclass_SmoothPath_GetResult_Event(type):
...
class SmoothPath_GetResult_Event(metaclass=Metaclass_SmoothPath_GetResult_Event):
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SmoothPath_GetResult_Request'"
        self._request = value
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SmoothPath_GetResult_Response'"
        self._response = value
...
class SmoothPath_GetResult(metaclass=Metaclass_SmoothPath_GetResult):
    ...
    from nav2_msgs.action._smooth_path import SmoothPath_GetResult_Event as Event
