...
class Metaclass_ComputePathThroughPoses_Goal(type):
    ...
    def NONE(self):
        ...
        return Metaclass_ComputePathThroughPoses_Goal.__constants['NONE']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['UNKNOWN']

    @property
    def INVALID_PLANNER(self):
        """Message constant 'INVALID_PLANNER'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['INVALID_PLANNER']

    @property
    def TF_ERROR(self):
        """Message constant 'TF_ERROR'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['TF_ERROR']

    @property
    def START_OUTSIDE_MAP(self):
        """Message constant 'START_OUTSIDE_MAP'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['START_OUTSIDE_MAP']

    @property
    def GOAL_OUTSIDE_MAP(self):
        """Message constant 'GOAL_OUTSIDE_MAP'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['GOAL_OUTSIDE_MAP']

    @property
    def START_OCCUPIED(self):
        """Message constant 'START_OCCUPIED'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['START_OCCUPIED']

    @property
    def GOAL_OCCUPIED(self):
        """Message constant 'GOAL_OCCUPIED'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['GOAL_OCCUPIED']

    @property
    def TIMEOUT(self):
        """Message constant 'TIMEOUT'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['TIMEOUT']

    @property
    def NO_VALID_PATH(self):
        """Message constant 'NO_VALID_PATH'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['NO_VALID_PATH']

    @property
    def NO_VIAPOINTS_GIVEN(self):
        """Message constant 'NO_VIAPOINTS_GIVEN'."""
        return Metaclass_ComputePathThroughPoses_Goal.__constants['NO_VIAPOINTS_GIVEN']
