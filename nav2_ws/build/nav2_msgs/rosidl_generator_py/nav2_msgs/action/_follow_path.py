...
class Metaclass_FollowPath_Goal(type):
    ...
    def NONE(self):
        ...
        return Metaclass_FollowPath_Goal.__constants['NONE']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_FollowPath_Goal.__constants['UNKNOWN']

    @property
    def INVALID_CONTROLLER(self):
        """Message constant 'INVALID_CONTROLLER'."""
        return Metaclass_FollowPath_Goal.__constants['INVALID_CONTROLLER']

    @property
    def TF_ERROR(self):
        """Message constant 'TF_ERROR'."""
        return Metaclass_FollowPath_Goal.__constants['TF_ERROR']

    @property
    def INVALID_PATH(self):
        """Message constant 'INVALID_PATH'."""
        return Metaclass_FollowPath_Goal.__constants['INVALID_PATH']

    @property
    def PATIENCE_EXCEEDED(self):
        """Message constant 'PATIENCE_EXCEEDED'."""
        return Metaclass_FollowPath_Goal.__constants['PATIENCE_EXCEEDED']

    @property
    def FAILED_TO_MAKE_PROGRESS(self):
        """Message constant 'FAILED_TO_MAKE_PROGRESS'."""
        return Metaclass_FollowPath_Goal.__constants['FAILED_TO_MAKE_PROGRESS']

    @property
    def NO_VALID_CONTROL(self):
        """Message constant 'NO_VALID_CONTROL'."""
        return Metaclass_FollowPath_Goal.__constants['NO_VALID_CONTROL']
