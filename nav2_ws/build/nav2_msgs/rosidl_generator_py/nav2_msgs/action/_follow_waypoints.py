...
class Metaclass_FollowWaypoints_Goal(type):
    ...
    def NONE(self):
        ...
        return Metaclass_FollowWaypoints_Goal.__constants['NONE']

    @property
    def UNKNOWN(self):
        """Message constant 'UNKNOWN'."""
        return Metaclass_FollowWaypoints_Goal.__constants['UNKNOWN']

    @property
    def TASK_EXECUTOR_FAILED(self):
        """Message constant 'TASK_EXECUTOR_FAILED'."""
        return Metaclass_FollowWaypoints_Goal.__constants['TASK_EXECUTOR_FAILED']
