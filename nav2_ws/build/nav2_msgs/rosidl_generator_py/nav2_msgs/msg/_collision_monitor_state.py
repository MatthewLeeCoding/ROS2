...
class Metaclass_CollisionMonitorState(type):
...
class CollisionMonitorState(metaclass=Metaclass_CollisionMonitorState):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.polygon_name = kwargs.get('polygon_name', str())
