...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__FollowPath_Result__rosidl_typesupport_introspection_c__FollowPath_Result_message_member_array[2] = {
  {
    "result",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
