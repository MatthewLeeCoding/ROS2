...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__SmoothPath_Result__rosidl_typesupport_introspection_c__SmoothPath_Result_message_member_array[4] = {
  {
    "path",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_Result, error_code),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
void nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  nav2_msgs__action__SmoothPath_SendGoal_Event__init(message_memory);
}

void nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_fini_function(void * message_memory)
{
  nav2_msgs__action__SmoothPath_SendGoal_Event__fini(message_memory);
}

size_t nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_SendGoal_Event__request(
  const void * untyped_member)
{
  const nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence * member =
    (const nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_SendGoal_Event__request(
...
void * nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_SendGoal_Event__request(
  void * untyped_member, size_t index)
{
  nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence * member =
    (nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_SendGoal_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const nav2_msgs__action__SmoothPath_SendGoal_Request * item =
    ((const nav2_msgs__action__SmoothPath_SendGoal_Request *)
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_SendGoal_Event__request(untyped_member, index));
  nav2_msgs__action__SmoothPath_SendGoal_Request * value =
    (nav2_msgs__action__SmoothPath_SendGoal_Request *)(untyped_value);
  *value = *item;
}

void nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_SendGoal_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  nav2_msgs__action__SmoothPath_SendGoal_Request * item =
    ((nav2_msgs__action__SmoothPath_SendGoal_Request *)
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_SendGoal_Event__request(untyped_member, index));
  const nav2_msgs__action__SmoothPath_SendGoal_Request * value =
    (const nav2_msgs__action__SmoothPath_SendGoal_Request *)(untyped_value);
  *item = *value;
}

bool nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_SendGoal_Event__request(
  void * untyped_member, size_t size)
{
  nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence * member =
    (nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence *)(untyped_member);
  nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence__fini(member);
  return nav2_msgs__action__SmoothPath_SendGoal_Request__Sequence__init(member, size);
}

size_t nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_SendGoal_Event__response(
  const void * untyped_member)
{
  const nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence * member =
    (const nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_SendGoal_Event__response(
  const void * untyped_member, size_t index)
{
  const nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence * member =
    (const nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence *)(untyped_member);
...
void * nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_SendGoal_Event__response(
  void * untyped_member, size_t index)
{
  nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence * member =
    (nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_SendGoal_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const nav2_msgs__action__SmoothPath_SendGoal_Response * item =
    ((const nav2_msgs__action__SmoothPath_SendGoal_Response *)
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_SendGoal_Event__response(untyped_member, index));
  nav2_msgs__action__SmoothPath_SendGoal_Response * value =
    (nav2_msgs__action__SmoothPath_SendGoal_Response *)(untyped_value);
  *value = *item;
}

void nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_SendGoal_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  nav2_msgs__action__SmoothPath_SendGoal_Response * item =
    ((nav2_msgs__action__SmoothPath_SendGoal_Response *)
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_SendGoal_Event__response(untyped_member, index));
  const nav2_msgs__action__SmoothPath_SendGoal_Response * value =
    (const nav2_msgs__action__SmoothPath_SendGoal_Response *)(untyped_value);
  *item = *value;
}

bool nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_SendGoal_Event__response(
  void * untyped_member, size_t size)
{
  nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence * member =
    (nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence *)(untyped_member);
  nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence__fini(member);
  return nav2_msgs__action__SmoothPath_SendGoal_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_SendGoal_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_SendGoal_Event, request),  // bytes offset in struct
    NULL,  // default value
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_SendGoal_Event__request,  // size() function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_SendGoal_Event__request,  // get_const(index) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_SendGoal_Event__request,  // get(index) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_SendGoal_Event__request,  // fetch(index, &value) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_SendGoal_Event__request,  // assign(index, value) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_SendGoal_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_SendGoal_Event, response),  // bytes offset in struct
    NULL,  // default value
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_SendGoal_Event__response,  // size() function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_SendGoal_Event__response,  // get_const(index) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_SendGoal_Event__response,  // get(index) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_SendGoal_Event__response,  // fetch(index, &value) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_SendGoal_Event__response,  // assign(index, value) function pointer
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_SendGoal_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_members = {
  "nav2_msgs__action",  // message namespace
  "SmoothPath_SendGoal_Event",  // message name
  3,  // number of fields
  sizeof(nav2_msgs__action__SmoothPath_SendGoal_Event),
  nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_member_array,  // message members
  nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_type_support_handle = {
  0,
  &nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_nav2_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_SendGoal_Event)() {
  nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_SendGoal_Request)();
  nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_SendGoal_Response)();
  if (!nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_type_support_handle.typesupport_identifier) {
    nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t nav2_msgs__action__detail__smooth_path__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_service_type_support_handle = {
  ...
  &nav2_msgs__action__SmoothPath_SendGoal_Request__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Request_message_type_support_handle,
  &nav2_msgs__action__SmoothPath_SendGoal_Response__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Response_message_type_support_handle,
  &nav2_msgs__action__SmoothPath_SendGoal_Event__rosidl_typesupport_introspection_c__SmoothPath_SendGoal_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_SendGoal)() {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_SendGoal_Event)()->data;
  }
...
void nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  nav2_msgs__action__SmoothPath_GetResult_Event__init(message_memory);
}

void nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_fini_function(void * message_memory)
{
  nav2_msgs__action__SmoothPath_GetResult_Event__fini(message_memory);
}

size_t nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_GetResult_Event__request(
  const void * untyped_member)
{
  const nav2_msgs__action__SmoothPath_GetResult_Request__Sequence * member =
    (const nav2_msgs__action__SmoothPath_GetResult_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_GetResult_Event__request(
  const void * untyped_member, size_t index)
{
  const nav2_msgs__action__SmoothPath_GetResult_Request__Sequence * member =
    (const nav2_msgs__action__SmoothPath_GetResult_Request__Sequence *)(untyped_member);
...
void * nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_GetResult_Event__request(
  void * untyped_member, size_t index)
{
  nav2_msgs__action__SmoothPath_GetResult_Request__Sequence * member =
    (nav2_msgs__action__SmoothPath_GetResult_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_GetResult_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const nav2_msgs__action__SmoothPath_GetResult_Request * item =
    ((const nav2_msgs__action__SmoothPath_GetResult_Request *)
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_GetResult_Event__request(untyped_member, index));
  nav2_msgs__action__SmoothPath_GetResult_Request * value =
    (nav2_msgs__action__SmoothPath_GetResult_Request *)(untyped_value);
  *value = *item;
}

void nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_GetResult_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  nav2_msgs__action__SmoothPath_GetResult_Request * item =
    ((nav2_msgs__action__SmoothPath_GetResult_Request *)
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_GetResult_Event__request(untyped_member, index));
  const nav2_msgs__action__SmoothPath_GetResult_Request * value =
    (const nav2_msgs__action__SmoothPath_GetResult_Request *)(untyped_value);
  *item = *value;
}

bool nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_GetResult_Event__request(
  void * untyped_member, size_t size)
{
  nav2_msgs__action__SmoothPath_GetResult_Request__Sequence * member =
    (nav2_msgs__action__SmoothPath_GetResult_Request__Sequence *)(untyped_member);
  nav2_msgs__action__SmoothPath_GetResult_Request__Sequence__fini(member);
  return nav2_msgs__action__SmoothPath_GetResult_Request__Sequence__init(member, size);
}

size_t nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_GetResult_Event__response(
  const void * untyped_member)
{
  const nav2_msgs__action__SmoothPath_GetResult_Response__Sequence * member =
    (const nav2_msgs__action__SmoothPath_GetResult_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_GetResult_Event__response(
  const void * untyped_member, size_t index)
{
  const nav2_msgs__action__SmoothPath_GetResult_Response__Sequence * member =
    (const nav2_msgs__action__SmoothPath_GetResult_Response__Sequence *)(untyped_member);
...
void * nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_GetResult_Event__response(
  void * untyped_member, size_t index)
{
  nav2_msgs__action__SmoothPath_GetResult_Response__Sequence * member =
    (nav2_msgs__action__SmoothPath_GetResult_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_GetResult_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const nav2_msgs__action__SmoothPath_GetResult_Response * item =
    ((const nav2_msgs__action__SmoothPath_GetResult_Response *)
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_GetResult_Event__response(untyped_member, index));
  nav2_msgs__action__SmoothPath_GetResult_Response * value =
    (nav2_msgs__action__SmoothPath_GetResult_Response *)(untyped_value);
  *value = *item;
}

void nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_GetResult_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  nav2_msgs__action__SmoothPath_GetResult_Response * item =
    ((nav2_msgs__action__SmoothPath_GetResult_Response *)
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_GetResult_Event__response(untyped_member, index));
  const nav2_msgs__action__SmoothPath_GetResult_Response * value =
    (const nav2_msgs__action__SmoothPath_GetResult_Response *)(untyped_value);
  *item = *value;
}

bool nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_GetResult_Event__response(
  void * untyped_member, size_t size)
{
  nav2_msgs__action__SmoothPath_GetResult_Response__Sequence * member =
    (nav2_msgs__action__SmoothPath_GetResult_Response__Sequence *)(untyped_member);
  nav2_msgs__action__SmoothPath_GetResult_Response__Sequence__fini(member);
  return nav2_msgs__action__SmoothPath_GetResult_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_member_array[3] = {
  {
    "info",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_GetResult_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_GetResult_Event, request),  // bytes offset in struct
    NULL,  // default value
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_GetResult_Event__request,  // size() function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_GetResult_Event__request,  // get_const(index) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_GetResult_Event__request,  // get(index) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_GetResult_Event__request,  // fetch(index, &value) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_GetResult_Event__request,  // assign(index, value) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_GetResult_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(nav2_msgs__action__SmoothPath_GetResult_Event, response),  // bytes offset in struct
    NULL,  // default value
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__size_function__SmoothPath_GetResult_Event__response,  // size() function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_const_function__SmoothPath_GetResult_Event__response,  // get_const(index) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__get_function__SmoothPath_GetResult_Event__response,  // get(index) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__fetch_function__SmoothPath_GetResult_Event__response,  // fetch(index, &value) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__assign_function__SmoothPath_GetResult_Event__response,  // assign(index, value) function pointer
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__resize_function__SmoothPath_GetResult_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_members = {
  "nav2_msgs__action",  // message namespace
  "SmoothPath_GetResult_Event",  // message name
  3,  // number of fields
  sizeof(nav2_msgs__action__SmoothPath_GetResult_Event),
  nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_member_array,  // message members
  nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_type_support_handle = {
  0,
  &nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_nav2_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_GetResult_Event)() {
  nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_GetResult_Request)();
  nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_GetResult_Response)();
  if (!nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_type_support_handle.typesupport_identifier) {
    nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t nav2_msgs__action__detail__smooth_path__rosidl_typesupport_introspection_c__SmoothPath_GetResult_service_type_support_handle = {
  ...
  get_service_typesupport_handle_function,
  &nav2_msgs__action__SmoothPath_GetResult_Request__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Request_message_type_support_handle,
  &nav2_msgs__action__SmoothPath_GetResult_Response__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Response_message_type_support_handle,
  &nav2_msgs__action__SmoothPath_GetResult_Event__rosidl_typesupport_introspection_c__SmoothPath_GetResult_Event_message_type_support_handle,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    nav2_msgs,
    action,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_GetResult)() {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, nav2_msgs, action, SmoothPath_GetResult_Event)()->data;
  }
