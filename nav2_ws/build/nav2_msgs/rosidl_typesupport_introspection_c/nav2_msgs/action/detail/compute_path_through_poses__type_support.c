...
static rosidl_typesupport_introspection_c__MessageMember nav2_msgs__action__ComputePathThroughPoses_Result__rosidl_typesupport_introspection_c__ComputePathThroughPoses_Result_message_member_array[3] = {
  {
    "path",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
