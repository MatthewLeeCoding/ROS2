...
public:
  ...
  : msg_(msg)
  {}
  ::nav2_msgs::action::AssistedTeleop_Result error_code(::nav2_msgs::action::AssistedTeleop_Result::_error_code_type arg)
  {
...
class Init_AssistedTeleop_SendGoal_Event_response
{
public:
  explicit Init_AssistedTeleop_SendGoal_Event_response(::nav2_msgs::action::AssistedTeleop_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::AssistedTeleop_SendGoal_Event response(::nav2_msgs::action::AssistedTeleop_SendGoal_Event::_response_type arg)
  {
...
private:
  ::nav2_msgs::action::AssistedTeleop_SendGoal_Event msg_;
};

class Init_AssistedTeleop_SendGoal_Event_request
{
public:
  explicit Init_AssistedTeleop_SendGoal_Event_request(::nav2_msgs::action::AssistedTeleop_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_AssistedTeleop_SendGoal_Event_response request(::nav2_msgs::action::AssistedTeleop_SendGoal_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_AssistedTeleop_SendGoal_Event_response(msg_);
  }
...
class Init_AssistedTeleop_SendGoal_Event_info
{
public:
  Init_AssistedTeleop_SendGoal_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AssistedTeleop_SendGoal_Event_request info(::nav2_msgs::action::AssistedTeleop_SendGoal_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_AssistedTeleop_SendGoal_Event_request(msg_);
  }
...
template<>
inline
auto build<::nav2_msgs::action::AssistedTeleop_SendGoal_Event>()
{
  return nav2_msgs::action::builder::Init_AssistedTeleop_SendGoal_Event_info();
}
...
class Init_AssistedTeleop_GetResult_Event_response
{
public:
  explicit Init_AssistedTeleop_GetResult_Event_response(::nav2_msgs::action::AssistedTeleop_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::AssistedTeleop_GetResult_Event response(::nav2_msgs::action::AssistedTeleop_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::nav2_msgs::action::AssistedTeleop_GetResult_Event msg_;
};

class Init_AssistedTeleop_GetResult_Event_request
{
public:
  explicit Init_AssistedTeleop_GetResult_Event_request(::nav2_msgs::action::AssistedTeleop_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_AssistedTeleop_GetResult_Event_response request(::nav2_msgs::action::AssistedTeleop_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
    return Init_AssistedTeleop_GetResult_Event_response(msg_);
  }
...
class Init_AssistedTeleop_GetResult_Event_info
{
public:
  Init_AssistedTeleop_GetResult_Event_info()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AssistedTeleop_GetResult_Event_request info(::nav2_msgs::action::AssistedTeleop_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
    return Init_AssistedTeleop_GetResult_Event_request(msg_);
  }
...
template<>
inline
auto build<::nav2_msgs::action::AssistedTeleop_GetResult_Event>()
{
  return nav2_msgs::action::builder::Init_AssistedTeleop_GetResult_Event_info();
}
