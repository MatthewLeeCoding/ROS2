...
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::NONE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::UNKNOWN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::INVALID_SMOOTHER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::TIMEOUT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::SMOOTHED_PATH_IN_COLLISION;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::FAILED_TO_SMOOTH_PATH;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t SmoothPath_Goal_<ContainerAllocator>::INVALID_PATH;
#endif  // __cplusplus < 201703L
...
#ifndef _WIN32
# define DEPRECATED__nav2_msgs__action__SmoothPath_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__nav2_msgs__action__SmoothPath_SendGoal_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct SmoothPath_SendGoal_Event_
{
  using Type = SmoothPath_SendGoal_Event_<ContainerAllocator>;

  explicit SmoothPath_SendGoal_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit SmoothPath_SendGoal_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nav2_msgs__action__SmoothPath_SendGoal_Event
    std::shared_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nav2_msgs__action__SmoothPath_SendGoal_Event
    std::shared_ptr<nav2_msgs::action::SmoothPath_SendGoal_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const SmoothPath_SendGoal_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using SmoothPath_SendGoal_Event =
  nav2_msgs::action::SmoothPath_SendGoal_Event_<std::allocator<void>>;
...
struct SmoothPath_SendGoal
{
  ...
  using Event = nav2_msgs::action::SmoothPath_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__nav2_msgs__action__SmoothPath_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__nav2_msgs__action__SmoothPath_GetResult_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct SmoothPath_GetResult_Event_
{
  using Type = SmoothPath_GetResult_Event_<ContainerAllocator>;

  explicit SmoothPath_GetResult_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit SmoothPath_GetResult_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::SmoothPath_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::SmoothPath_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nav2_msgs__action__SmoothPath_GetResult_Event
    std::shared_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nav2_msgs__action__SmoothPath_GetResult_Event
    std::shared_ptr<nav2_msgs::action::SmoothPath_GetResult_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const SmoothPath_GetResult_Event_ & other) const
  {
    if (this->info != other.info) {
      return false;
    }
...
// alias to use template instance with default allocator
using SmoothPath_GetResult_Event =
  nav2_msgs::action::SmoothPath_GetResult_Event_<std::allocator<void>>;
...
struct SmoothPath_GetResult
{
  ...
  using Event = nav2_msgs::action::SmoothPath_GetResult_Event;
};
