...
{
public:
  explicit Init_SaveMap_Event_response(::nav2_msgs::srv::SaveMap_Event & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::srv::SaveMap_Event response(::nav2_msgs::srv::SaveMap_Event::_response_type arg)
  {
...
private:
  ::nav2_msgs::srv::SaveMap_Event msg_;
};

class Init_SaveMap_Event_request
{
public:
  explicit Init_SaveMap_Event_request(::nav2_msgs::srv::SaveMap_Event & msg)
  : msg_(msg)
  {}
  Init_SaveMap_Event_response request(::nav2_msgs::srv::SaveMap_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_SaveMap_Event_request info(::nav2_msgs::srv::SaveMap_Event::_info_type arg)
  {
...
template<>
inline
auto build<::nav2_msgs::srv::SaveMap_Event>()
{
  return nav2_msgs::srv::builder::Init_SaveMap_Event_info();
}
