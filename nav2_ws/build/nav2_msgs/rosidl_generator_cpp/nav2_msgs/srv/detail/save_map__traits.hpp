...
[[deprecated("use nav2_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const nav2_msgs::srv::SaveMap_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  nav2_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use nav2_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const nav2_msgs::srv::SaveMap_Event & msg)
{
  return nav2_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<nav2_msgs::srv::SaveMap_Event>()
{
  return "nav2_msgs::srv::SaveMap_Event";
}

template<>
inline const char * name<nav2_msgs::srv::SaveMap_Event>()
{
  return "nav2_msgs/srv/SaveMap_Event";
}
